...
public class PKAnchorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.setVideoBitrateRange(200 * 1000, 500 * 1000);
        // 20 fps is enough
        ...
        /**
         * Step 9: config streaming profile(only anchor)
         */
         ...
         */
        PreviewAppearance appearance = new PreviewAppearance(0.0f, 0.0f, 0.5f, 1.0f, PreviewAppearance.ScaleType.FULL);

        /**
         * Step 10: do prepare
         */
        mRTCStreamingManager.prepare(cameraStreamingSetting, null,  watermarksetting, mStreamingProfile, appearance);
    ...
    protected void onResume() {
        ...
        /**
         * Step 11: You must start capture before conference or streaming
    ...
    protected void onPause() {
        ...
        /**
         * Step 12: You must stop capture, stop conference, stop streaming when activity paused
         */
    ...
    protected void onDestroy() {
        super.onDestroy();
        /**
         * Step 13: You must call destroy to release some resources when activity destroyed
         */
        mRTCStreamingManager.destroy();
        /**
         * Step 14: You can also move this to your MainActivity.onDestroy
         */
