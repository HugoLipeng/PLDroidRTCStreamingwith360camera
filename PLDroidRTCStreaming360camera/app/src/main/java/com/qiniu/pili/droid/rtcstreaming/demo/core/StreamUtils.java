...
public class StreamUtils {
    ...
    public static final String APP_SERVER_BASE = "abc";
    ...
    private static String requestStreamURL(String roomName) {
        String url = "rtmp://pili-publish.lipengv2.qiniuts.com/lipengv2/hugoforstream?key=588dc25b3e5bdf42";//APP_SERVER_BASE + "getPublishURL&roomName=" + roomName;
        return url;//return doRequest("GET", url);
    }
...
//        String url = APP_SERVER_BASE + "/play/" + roomName;
    ...
    public static String requestRoomToken(String userId, String roomName) {
        String url = APP_SERVER_BASE + "roomToken&userId=" + userId + "&roomName=" + roomName + "&perm=admin";
        return doRequest("GET", url);
    }
